...
files_to_fix = [
    {
        "path": r"D:\Workspace\StudyMaterial\Day1\lc-0001-two-sum.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day1\lc-0217-contains-duplicate.ipynb",
        "pattern": "Hash Set",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day1\lc-0238-product-array-except-self.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day1\lc-0242-valid-anagram.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day1\lc-0347-top-k-frequent-elements.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day2\lc-0003-longest-substring-without-repeating-characters.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day2\lc-0076-minimum-window-substring.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day2\lc-0121-best-time-to-buy-and-sell-stock.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day2\lc-0239-sliding-window-maximum.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day2\lc-0424-longest-repeating-character-replacement.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day3\lc-0020-valid-parentheses.ipynb",
        "pattern": "Stack (LIFO)",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day3\lc-0022-generate-parentheses.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day3\lc-0150-evaluate-reverse-polish-notation.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day3\lc-0739-daily-temperatures.ipynb",
    ...
    {
        "path": r"D:\Workspace\StudyMaterial\Day3\lc-0853-car-fleet.ipynb",
...
for item in files_to_fix:
    summary_md = f"""## 🎯 Summary: Key Takeaways
...
Master **{item['pattern']}** and you've mastered one of the most common patterns in data engineering interviews. 🚀"""
    ...
    # We need to manually split by new line and append the \n except for the last line.
    summary_lines = [line + "\n" for line in summary_md.split("\n")]
    summary_lines[-1] = summary_lines[-1].replace("\n", "")

    closing_lines = [line + "\n" for line in closing_md.split("\n")]
    closing_lines[-1] = closing_lines[-1].replace("\n", "")
...
print("15 files successfully updated!")
